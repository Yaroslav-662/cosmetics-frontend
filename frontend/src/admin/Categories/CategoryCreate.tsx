...
import { adminCreateCategory } from "@/admin/api/admin.api";
...
export default function CategoryCreate() {
  ...
  async function onSave() {
    ...
    setSaving(true);
    try {
      await adminCreateCategory({ name, description: form.description?.trim() || undefined });
  ...
  return (
    <>
      <MetaTags title="Admin — Create Category" />
      <AdminShell
        title="Create category"
        subtitle="POST /api/categories (required: name; optional: description)"
